...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Camera Zoom', "Locks the Camera Zoom.\nValue 1: The Zoom Vaule."]
	];
	...
	**/
	...
	function addChartingUI() {
		...
		if (vocals != null) voicesVolume.value = vocals.volume;
	...
	override function update(elapsed:Float)
	{
		...
		bpmTxt.text = FlxStringUtil.formatTime(secondsTotal, false) + " / " + FlxStringUtil.formatTime(Math.floor(FlxG.sound.music.length / 1000), false) +
