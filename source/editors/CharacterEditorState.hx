...
class CharacterEditorState extends MusicBeatState
{
	...
	function addCharacterUI() {
		...
		tab_group.add(new FlxText(scaleStepper.x, scaleStepper.y + 20, 0, "Nuh uh you can't adjust the\ncharacter's healthbar color", 10));
	...
	function resetHealthBarColor() {
		...
		healthBarBG.color = !check_player.checked ? FlxColor.RED : 0x00FF00;
	}
